...
// MP3 HEADERS
// MP3:::000040[a-f0-9]{2}[a-f0-9]{2}00.*::::::.*\.mp3
// MP3:::000064000000.*::::::.*\.mp3
// MP3:::000044[a-f0-9]{2}[a-f0-9]{2}00.*::::::.*\.mp3
// MP3:::[a-f0-9]*4c414d45(32|33|34)2e.*:::LAME MP3 Encoder:::.*\.mp3
func Mp3(buf []byte) bool {
	return len(buf) > 2 &&
		...
		(buf[0] == 0x49 && buf[1] == 0x44 && buf[2] == 0x33) || // ID3v2
			...
			// FFFA{XX}
			// MP3:::[a-f0-9]*fffa90[a-f0-9]{2}00[a-f0-9]{2}.*::::::.*\.mp3
			// MP3:::[a-f0-9]*fffab2[a-f0-9]{2}.*::::::.*\.mp3
			(buf[0] == 0xFF && buf[1] == 0xFA && (buf[2] == 0x90 || buf[2] == 0xB2)) ||

			// FFFB{XX}
			// MP3:::[a-f0-9]*fffb68[a-f0-9]{2}00[a-f0-9]{2}.*::::::.*\.mp3
			// MP3:::[a-f0-9]*fffb40[a-f0-9]{2}00[a-f0-9]{2}.*::::::.*\.mp3
			// MP3:::[a-f0-9]*fffb90[a-f0-9]{2}00[a-f0-9]{2}.*::::::.*\.mp3
			// MP3:::[a-f0-9]*fffb50[a-f0-9]{2}00[a-f0-9]{2}.*::::::.*\.mp3
			// MP3:::[a-f0-9]*fffb92[a-f0-9]{2}00[a-f0-9]{2}.*::::::.*\.mp3
